...
/** FUNCTIONALITY-DEFINING VARIABLES *****************************************/
    ...
    */
    ...
    Configure::write(
        'tabs_order_default',
        array("My Home", "Activity Diary", "Report My Experiences", 
                "View My Reports", 
                "View Reports", "Manage My Fatigue", "Manage Other Symptoms", 
                //"Share My Reports", 
                "Patients",
                "Data Access", "Editor"));

    // if defined and true, patients w/ missing activity diary data are redirected to that tab on login 
    define('ACTIVITY_DIARY_REDIRECT_ON_LOGIN', true);
...
/** INSTANCE-SPECIFIC STRINGS ************************************************/
    ...
    define('SHORT_TITLE', "ESRA-C");

    // default page <title>
    define('PAGE_TITLE', "ESRA-C");
