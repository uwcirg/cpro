...
/** SESSION LIFE RELATED *****************************************************/
    ...
    define ('MIN_SECONDS_BETWEEN_APPTS', 1209600); // 2 weeks
...
/** INSTANCE-SPECIFIC STRINGS ************************************************/
    ...
    define('SHORT_TITLE', "mPOWEr");

    // default page <title>
    define('PAGE_TITLE', "mPOWEr");

    define('LOGIN_WELCOME', 'Welcome to mPOWEr');
