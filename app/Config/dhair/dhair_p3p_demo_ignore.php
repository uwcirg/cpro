    ...
    */
    Configure::write(
        ...
        array(
            ...
            /* locale_selections removed from P3P to hide language toggle. To
             * reimplement, just uncomment. */
            //'locale_selections', 
            'patient_extension',
        ));
...
/** PATIENT RELATED **********************************************************/
    ...
    define('INITIAL_CONSENT_STATUS', 'consented');
    ...
    Configure::write('DEMO_DONT_TOUCH_PATIENTS', array(6));
    Configure::write('DEMO_RESET_BUT_DONT_DELETE_PATIENTS', array(504));
    Configure::write('DEMO_RESET_SQL', array(
        'INSERT INTO survey_sessions_deleted SELECT * FROM survey_sessions WHERE project_id = 3 AND survey_sessions.patient_id = ',
        'DELETE FROM survey_sessions WHERE project_id = 3 AND patient_id = ',
        'UPDATE patients SET farthestStepInIntervention = NULL WHERE id = ',
        'UPDATE `appointments` SET datetime = (datetime + INTERVAL 1 DAY) WHERE patient_id = ',
        'INSERT INTO patients_p3p_teachings_deleted SELECT * FROM patients_p3p_teachings WHERE patients_p3p_teachings.patient_id = ',
        'DELETE FROM patients_p3p_teachings WHERE patient_id = ')
    );
