...
/** PATIENT-COMMUNICATION CHANNEL VARIABLES **********************************/
    ...
    define('STAFF_GUIDE', 'http://goo.gl/zG3Xp');
...
/** SESSION LIFE RELATED *****************************************************/
    ...
    define ('MIN_SECONDS_BETWEEN_APPTS', 86400); // 1 day
...
/** INSTANCE-SPECIFIC STRINGS ************************************************/
    ...
    define('LOGIN_WELCOME', 'PainTracker™ is an easy-to-use, web-based service that helps clinicians track and improve the core outcomes of chronic pain management.  The PainTracker™ web service is used in the context of telemedicine, provided through UW TelePain, a telemedicine program of the University of Washington operating throughout the WWAMI region.<br/><br/>
