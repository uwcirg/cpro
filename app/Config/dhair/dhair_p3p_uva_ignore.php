 ...
 * 
 * For the University of Virginia's P3P system
 * 
    ...
    Configure::write(
        'tabControllerActionMap', array(
                                    'Welcome' => array('controller'=>'users',
                                                       'action'=>'index'),
                                    //__('My Home') => array('controller'=>'users',
                                    'My Home' => array('controller'=>'users',
                                                       'action'=>'index'),
                                    //__('Report My Experiences') => array('controller'=>'surveys',
    ...
    Configure::write(
        ...
        array("My Home", "Build My P3P",
                "View My P3P", "Important Factors", "Statistics", 
                    "My Decision Role", "Next Steps", 
                "Patients",
                "Data Access", "Editor"));
        /**array(__("My Home"), __("Report My Experiences"), 
                "Patients",
                "Data Access", "Survey Editor"));*/
...
/** INSTANCE-SPECIFIC STRINGS ************************************************/
    ...
    // default page <title>
    define('PAGE_TITLE', "Personal Patient Profile / UVA Prostate Center");

    define('LOGIN_WELCOME', 'Welcome to the UVA Prostate Center\'s Personal Profile for Prostate (P3P). This website gives patients with prostate cancer a way to report health information to their care team.');
