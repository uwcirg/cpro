...
) ENGINE=MyISAM AUTO_INCREMENT=22390 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `appointments_deleted`
--

DROP TABLE IF EXISTS `appointments_deleted`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `appointments_deleted` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `patient_id` int(11) NOT NULL,
  `datetime` datetime DEFAULT NULL,
  `location` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
/*!50001 CREATE TABLE `aros_acos_interpreted_view` (
 `id` tinyint NOT NULL,
  `aro_id` tinyint NOT NULL,
  `aros_alias` tinyint NOT NULL,
  `aco_id` tinyint NOT NULL,
  `acos_alias` tinyint NOT NULL,
  `_create` tinyint NOT NULL,
  `_read` tinyint NOT NULL,
  `_update` tinyint NOT NULL,
  `_delete` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `aros_backup`
--

DROP TABLE IF EXISTS `aros_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aros_backup` (
...
/*!50001 CREATE TABLE `itemsThroughScalesByProject` (
 `item_id` tinyint NOT NULL,
  ...
  `subscale_id` tinyint NOT NULL,
  `subscale_name` tinyint NOT NULL,
  `subscale_order` tinyint NOT NULL,
  `scale_id` tinyint NOT NULL,
  `scale_name` tinyint NOT NULL,
  `scale_order` tinyint NOT NULL,
  `questionnaire_id` tinyint NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=918 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `logs` (
  ...
  `time` datetime NOT NULL,
  `ip_address` varchar(55) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_agent` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id_index` (`user_id`),
  KEY `patient_id` (`patient_id`)
) ENGINE=MyISAM AUTO_INCREMENT=233116 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notes` (
  ...
  `flag_type` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'comma-separated list',
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
...
CREATE TABLE `options` (
  ...
  `OptionType` enum('radio','checkbox','dropdown','text','textbox','combo-radio','combo-check','button-yes','button-no','imagemap','none','image','month','day','year') NOT NULL DEFAULT 'radio',
...
) ENGINE=MyISAM AUTO_INCREMENT=7457 DEFAULT CHARSET=utf8 PACK_KEYS=0;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE TABLE `participant_demographics` (
 `patient id` tinyint NOT NULL,
  `gender` tinyint NOT NULL,
  `clinic` tinyint NOT NULL,
  `survey_session` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `patient_extensions` (
  ...
  `one_month_mode_pref` enum('online','mail') COLLATE utf8_unicode_ci DEFAULT NULL,
  `one_month_wont_complete` tinyint(1) NOT NULL,
  `one_month_wont_complete_reason` varchar(55) COLLATE utf8_unicode_ci DEFAULT NULL,
  `one_month_first_mailing` date DEFAULT NULL,
  `one_month_second_mailing` date DEFAULT NULL,
  `one_month_received_on` date DEFAULT NULL,
  `one_month_postmarked_on` date DEFAULT NULL,
  `one_month_faxed_on` date DEFAULT NULL,
  `one_month_fax_recd_on` date DEFAULT NULL,
  `six_month_mode_pref` enum('online','mail') COLLATE utf8_unicode_ci DEFAULT NULL,
  `six_month_wont_complete` tinyint(1) NOT NULL,
  `six_month_wont_complete_reason` varchar(55) COLLATE utf8_unicode_ci DEFAULT NULL,
  `six_month_first_mailing` date DEFAULT NULL,
  `six_month_second_mailing` date DEFAULT NULL,
  `six_month_received_on` date DEFAULT NULL,
  `six_month_postmarked_on` date DEFAULT NULL,
  `six_month_faxed_on` date DEFAULT NULL,
  `six_month_fax_recd_on` date DEFAULT NULL,
  PRIMARY KEY (`patient_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `patient_extensions_deleted`
--

DROP TABLE IF EXISTS `patient_extensions_deleted`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patient_extensions_deleted` (
  `patient_id` int(11) NOT NULL,
  `primary_randomization_date` datetime DEFAULT NULL,
  `wtp_status` enum('Completed','Unable to reach','Patient refused') COLLATE utf8_unicode_ci DEFAULT NULL,
  `wtp_randomization_date` datetime DEFAULT NULL COMMENT 'Willingness to pay randomization date',
...
CREATE TABLE `patients` (
  ...
  `external_study_id` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=2563 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `patients_clinics_vw`
--

DROP TABLE IF EXISTS `patients_clinics_vw`;
/*!50001 DROP VIEW IF EXISTS `patients_clinics_vw`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `patients_clinics_vw` (
 `name` tinyint NOT NULL,
  `id` tinyint NOT NULL,
  `MRN` tinyint NOT NULL,
  `test_flag` tinyint NOT NULL,
  `phone1` tinyint NOT NULL,
  `phone2` tinyint NOT NULL,
  `mailing_address` tinyint NOT NULL,
  `study_participation_flag` tinyint NOT NULL,
  `user_type` tinyint NOT NULL,
  `consent_status` tinyint NOT NULL,
  `consent_date` tinyint NOT NULL,
  `consenter_id` tinyint NOT NULL,
  `consent_checked` tinyint NOT NULL,
  `hipaa_consent_checked` tinyint NOT NULL,
  `clinical_service` tinyint NOT NULL,
  `treatment_start_date` tinyint NOT NULL,
  `birthdate` tinyint NOT NULL,
  `gender` tinyint NOT NULL,
  `ethnicity` tinyint NOT NULL,
  `eligible_flag` tinyint NOT NULL,
  `study_group` tinyint NOT NULL,
  `check_again_date` tinyint NOT NULL,
  `no_more_check_agains` tinyint NOT NULL,
  `off_study_status` tinyint NOT NULL,
  `off_study_reason` tinyint NOT NULL,
  `off_study_timestamp` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `patients_clinics_vw_count`
--

DROP TABLE IF EXISTS `patients_clinics_vw_count`;
/*!50001 DROP VIEW IF EXISTS `patients_clinics_vw_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `patients_clinics_vw_count` (
 `COUNT(*)` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `patients_p3p_teachings` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4931 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `patients_p3p_teachings_deleted`
--

DROP TABLE IF EXISTS `patients_p3p_teachings_deleted`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patients_p3p_teachings_deleted` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `patient_id` int(11) NOT NULL,
  `p3p_teaching_id` int(11) NOT NULL,
  `visited` datetime NOT NULL,
...
CREATE TABLE `projects` (
  ...
  `taken_break_txt` varchar(255) DEFAULT NULL COMMENT 'Set to the string ''false'' to suppress the default msg',
...
) ENGINE=MyISAM AUTO_INCREMENT=2161 DEFAULT CHARSET=utf8 PACK_KEYS=0;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=15822 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `session_scales` (
  ...
  PRIMARY KEY (`id`),
  KEY `survey_session_id` (`survey_session_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1925 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=857 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE TABLE `survey_sessions_appt_dt` (
 `id` tinyint NOT NULL,
  ...
  `partial_finalization` tinyint NOT NULL,
  `finished` tinyint NOT NULL,
  `appt_dt` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `teaching_tips_subs_scales_view` (
 `subscale_id` tinyint NOT NULL,
  ...
  `scale_id` tinyint NOT NULL,
  `scale_name` tinyint NOT NULL,
  `teaching_tips_id` tinyint NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=431 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Final view structure for view `patients_clinics_vw`
--

/*!50001 DROP TABLE IF EXISTS `patients_clinics_vw`*/;
/*!50001 DROP VIEW IF EXISTS `patients_clinics_vw`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`mcjustin`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `patients_clinics_vw_count` AS select count(0) AS `COUNT(*)` from `patients_clinics_vw` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2013-12-10 12:21:16
