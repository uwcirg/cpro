...
echo String::insert(
    __('<strong>You can only participate in the program if you use the website before your appointment on :appointment_date at :appointment_time</strong>, so please register now:'),
    array(
