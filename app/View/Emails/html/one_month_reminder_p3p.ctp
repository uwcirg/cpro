...
<p>
<?php
echo __('About 1 month ago, you joined the P3P program. We are contacting you now for the 1-month follow-up, which is an important part of our understanding the P3P results.');
?>
</p>
<p>
<?php
echo String::insert(
    __('We hope you can take a short time to answer the 1-month follow-up questionnaire. Please :link_startvisit the P3P website for your 1-month follow-up now:link_end, or before :end_date'),
    array(
        'link_start' =>
        ...
        'link_end' => '</a>',
        'end_date' => $patientProjectsStates[P3P_1_MO_FU_PROJECT]->availableDateRangeEnd,
    )
);
?>
</p>
