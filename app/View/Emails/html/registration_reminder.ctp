...
Hello <?php echo $user['User']['first_name']; ?>,<br><br>
It has been over <?php echo $weekNum; ?> week<?php if ($weekNum>1) echo 's'; ?> since your doctor's office registered you for the <?php echo EMAIL_TITLE; ?>.<br /><br />
